...
![在这里插入图片描述](Spring Boot上/20210205004146543-16810069823751.png)
...
![在这里插入图片描述](Spring Boot上/20210205004250581.png)
...
### 分布式
![在这里插入图片描述](Spring Boot上/2021020500434620.png)
...
![在这里插入图片描述](Spring Boot上/20210205004523307.png)
...
![在这里插入图片描述](Spring Boot上/20210205004621290.png)
...
### 官网文档架构
![在这里插入图片描述](Spring Boot上/20210205004733270.png)
![在这里插入图片描述](image/20210205004828702.png)

[查看版本新特性](https://github.com/spring-projects/spring-boot/wiki#release-notes)

![在这里插入图片描述](Spring Boot上/20210205005342147.png)
...
![image-20230409231413118](Spring Boot上/image-20230409231413118.png)

![image-20230409231352833](Spring Boot上/image-20230409231352833.png)
...
![在这里插入图片描述](Spring Boot上/20210205005453173.png)
...
![image-20230410135732888](Spring Boot上/image-20230410135732888.png)
...
![image-20230410140052695](Spring Boot上/image-20230410140052695.png)

==得导了Advice这个类才生效，因为他有注解 @ConditionalOnClass(Advice.class)==
...
- 每个自动配置类按照条件进行生效，默认都会绑定配置文件指定的值。（xxxxProperties里面读取，xxxProperties和配置文件进行了绑定)
    - 如何进行绑定：在配置类中加上@EnableConfigurationProperties(类的名字.class)类加入到容器中
    - 在类上使用注解@ConfigurationProperties(prefix = "配置文件的名字") 
...
$$ 深入Web原理= \left\{ \begin{matrix} SpringMVC自动配置概览 \\ 简单功能分析 \\ 请求参数处理 \\ 数据响应与内容协商 \\ 视图解析与模板引擎 \\ 拦截器 \\跨域 \\ 异常处理 \\ 原生Servlet组件 \\ 嵌入式web容器 \\ 定制化原理\end{matrix} \right. $$
...
## 28、请求处理-【源码分析】-请求映射原理
![在这里插入图片描述](Spring Boot上/20210205005703527.png)
...
![在这里插入图片描述](Spring Boot上/20210205005802305.png)
其中，保存了所有`@RequestMapping` 和`handler`的映射规则。

![在这里插入图片描述](Spring Boot上/20210205005926474.png)
...
![在这里插入图片描述](Spring Boot上/20210205010047654.png)
...
![在这里插入图片描述](Spring Boot上/20210205010247689.png)
...
![在这里插入图片描述](Spring Boot上/20210205010403920.jpg)
...
![在这里插入图片描述](Spring Boot上/20210205010509984.png)
